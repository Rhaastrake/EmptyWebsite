...
Il servizio include consigli pratici, interventi mirati e spiegazioni chiare, lasciando a te la decisione finale su come procedere.`,
    ...
    Si tratta di un PC fisso o portatile? *
      <input type="radio" class="btn-check" name="pcType" id="desktop" autocomplete="off" required>
      <label class="btn btn-outline-primary" for="desktop">Fisso</label>

      <input type="radio" class="btn-check" name="pcType" id="laptop" autocomplete="off">
      <label class="btn btn-outline-primary" for="laptop">Portatile</label>
    ...
    Di cosa hai bisogno? *
      ...
      <input type="radio" class="btn-check" name="serviceSpecification" id="unknownProblem" autocomplete="off">
      <label class="btn btn-outline-primary" for="unknownProblem">Non si accende</label>

      <input type="radio" class="btn-check" name="serviceSpecification" id="cleaning" autocomplete="off">
      <label class="btn btn-outline-primary" for="cleaning">Pulizia</label>


      <input type="radio" class="btn-check" name="serviceSpecification" id="software" autocomplete="off">
      <label class="btn btn-outline-primary" for="software">Programmi</label>

      <input type="radio" class="btn-check" name="serviceSpecification" id="hardware" autocomplete="off">
      <label class="btn btn-outline-primary" for="hardware">Cambio componenti</label>
  ...
  serviceButtons.forEach((currentService, index) => {
    currentService.addEventListener("click", () => {
      // Nasconde il form precedente e mostra di nuovo l'overview
